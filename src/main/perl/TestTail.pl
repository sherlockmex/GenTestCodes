...
print STDOUT "Abriendo archivo ".$file_name." con File::Tail\n";
my $file;

$file=File::Tail->new($file_name);

print STDOUT "Archivo abierto. Abriendo archivo filtrado ".$file_name.".filtrado\n";
...
print STDOUT "Procesando archivo....\n";
